...
Now that we're ready to create a Spring Boot project, head to [Spring Initializr](https://start.spring.io/), the official Spring Boot project generator (honorable mention to [Bootify](https://bootify.io/), interesting alternative).
...
**Packaging** determines how your application is bundled into a single, shareable file, and lets it run on any system without complex setup.
