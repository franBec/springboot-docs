...
2. Gets the films information from a [Sakila](/prior-recommended-knowledge/sakila-sample-database) [H2 database](/persistence-integration/database-integration).
