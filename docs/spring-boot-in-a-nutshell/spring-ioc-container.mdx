...
You tell Spring what you need by asking for the [interface](/prior-recommended-knowledge/interfaces-and-implementations). There are a few ways to do it, but only one right way.
