...
Each layer adds a level of abstraction. You almost always work at the top. When something breaks (a query performs badly, a mapping is wrong, a transaction doesn't behave as expected) knowing this stack tells you where to look. Next, we'll reverse-engineer JPA entities from an existing database schema.
