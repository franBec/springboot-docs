...
import {
  SynchronousSequenceDiagram,
  AsynchronousSequenceDiagram,
} from '@site/src/components/docs/prior-recommended-knowledge/core-concepts/communication-between-systems';
...
Now that you know this, you'll never look at a "Connection timed out" error the same way again.
