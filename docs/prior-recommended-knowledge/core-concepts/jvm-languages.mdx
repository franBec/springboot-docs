...
[Kotlin](https://kotlinlang.org/) hails from JetBrains, the same folks who brought you [IntelliJ IDEA](/prior-recommended-knowledge/ide#why-does-everyone-use-intellij-idea).
