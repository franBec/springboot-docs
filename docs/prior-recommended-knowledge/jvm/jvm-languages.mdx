...
import { JvmBytecodeDiagram } from '@site/src/components/docs/prior-recommended-knowledge/jvm/jvm-languages';
...
Bias alert: I have a soft spot for [Groovy](https://groovy-lang.org/), as it was the language I used at my first dev job back in 2021.
