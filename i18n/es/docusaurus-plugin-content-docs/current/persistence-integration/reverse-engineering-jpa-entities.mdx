...
description: Genera clases de entidad JPA en tiempo de build directamente desde un esquema SQL existiente en lugar de escribirlas a mano.
---

import GithubCommitsInfo from '@site/src/components/github-commits-info';
import { FileTree } from '@site/src/components/docs/persistence-integration/reverse-engineering-jpa-entities';
...
<GithubCommitsInfo
  commits={[
    {
      name: 'Reverse Engineering JPA Entities (spring_groovy)',
      url: 'https://github.com/franBec/springboot-demo-projects/commit/66c833e262c22d4680841942a5d10407e8f2cfdb',
    },
    {
      name: 'Reverse Engineering JPA Entities (spring_java)',
      url: 'https://github.com/franBec/springboot-demo-projects/commit/90328ae095a29bd4836acb6a1ba1be12d60baad8',
    },
    {
      name: 'Reverse Engineering JPA Entities (spring_kotlin)',
      url: 'https://github.com/franBec/springboot-demo-projects/commit/4e76c9ec9ddd263e39428da82115a414304231c2',
    },
  ]}
/>

En el [documento anterior](./how-spring-talks-to-databases) vimos cómo Spring Boot se comunica con una base de datos a través de JDBC, Hibernate y Spring Data JPA. Ahora invertimos la dirección: en lugar de escribir las clases de entidad a mano y dejar que Hibernate genere el esquema, partimos de un esquema SQL existente y generamos las clases de entidad en tiempo de compilación.
...
<Tabs groupId="language" queryString>
    <TabItem value="java" label="Java" default>
        ...
        ```xml reference title="resources/hibernate.reveng.xml"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/src/main/resources/hibernate.reveng.xml
        ```
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        ```xml reference title="resources/hibernate.reveng.xml"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/src/main/resources/hibernate.reveng.xml
        ```
    ...
    <TabItem value="groovy" label="Groovy">
        ...
        ```xml reference title="resources/hibernate.reveng.xml"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/src/main/resources/hibernate.reveng.xml
        ```
...
<Tabs groupId="language" queryString>
    <TabItem value="java" label="Java" default>
        ...
        ```properties reference title="resources/hibernate-tools.properties"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/src/main/resources/hibernate-tools.properties
        ```
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        ```properties reference title="resources/hibernate-tools.properties"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/src/main/resources/hibernate-tools.properties
        ```
    ...
    <TabItem value="groovy" label="Groovy">
        ...
        ```properties reference title="resources/hibernate-tools.properties"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/src/main/resources/hibernate-tools.properties
        ```
...
<Tabs groupId="language" queryString>
    <TabItem value="java" label="Java" default>
        ...
        ```ftl reference title="resources/templates/hibernate/pojo/Pojo.ftl"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/src/main/resources/templates/hibernate/pojo/Pojo.ftl
        ```
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        ```ftl reference title="resources/templates/hibernate/pojo/Pojo.ftl"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/src/main/resources/templates/hibernate/pojo/Pojo.ftl
        ```
    ...
    <TabItem value="groovy" label="Groovy">
        ...
        ```ftl reference title="resources/templates/hibernate/pojo/Pojo.ftl"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/src/main/resources/templates/hibernate/pojo/Pojo.ftl
        ```
...
<Tabs groupId="language" queryString>
    <TabItem value="java" label="Java" default>
        ...
        ```groovy reference title="build.gradle (updated configurations block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/build.gradle#L20-L25
        ```

        ```groovy reference title="build.gradle (dependencies block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/build.gradle#L56-L66
        ```

        ```groovy reference title="build.gradle (new task generateEntities + updated sourceSets + updated task compileJava blocks)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/90328ae095a29bd4836acb6a1ba1be12d60baad8/spring_java/build.gradle#L177-L267
        ```

    </TabItem>
    <TabItem value="kotlin" label="Kotlin">

        ```kts reference title="build.gradle.kts (new imports)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/build.gradle.kts#L1-L2
        ```

        ```kts reference title="build.gradle.kts (new val hibernateTools)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/build.gradle.kts#L23
        ```

        ```kts reference title="build.gradle.kts (dependencies block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/build.gradle.kts#L59-L69
        ```

        ```kts reference title="build.gradle.kts (new val hibernateGeneratedSourcesDir)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/build.gradle.kts#L160
        ```

        ```kts reference title="build.gradle.kts (new task generateEntities)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/4e76c9ec9ddd263e39428da82115a414304231c2/spring_kotlin/build.gradle.kts#L200-L305
        ```
    ...
    <TabItem value="groovy" label="Groovy">
        ...
        ```groovy reference title="build.gradle (updated configurations block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/build.gradle#L20-L25
        ```

        ```groovy reference title="build.gradle (dependencies block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/build.gradle#L55-L65
        ```

        ```groovy reference title="build.gradle (updated spotless block)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/build.gradle#L135-L146
        ```

        ```groovy reference title="build.gradle (new task generateEntities + updated sourceSets)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/build.gradle#L172-L266
        ```

        ```groovy reference title="build.gradle (new task compileGroovy)"
        https://raw.githubusercontent.com/franBec/springboot-demo-projects/66c833e262c22d4680841942a5d10407e8f2cfdb/spring_groovy/build.gradle#L272-L274
        ```
...
- **Dependencias de runtime y compilación** agregan los jars estándares de Spring Data JPA y H2 que tu aplicación necesita en runtime.
