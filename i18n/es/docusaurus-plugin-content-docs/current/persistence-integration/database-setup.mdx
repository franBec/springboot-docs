...
El `docker-compose.yml` está listo para desplegar en cualquier lugar donde Docker esté ejecutándose. Vamos a usar la misma instancia de Coolify que configuramos en la guía de [deployment on a VPS](/es/docs/deployment/deployment-on-a-vps).
