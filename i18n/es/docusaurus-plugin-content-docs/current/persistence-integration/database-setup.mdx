...
description: Reemplaza el H2 embebido con PostgreSQL 17 y usa Flyway para manejar migraciones de esquema para tus aplicaciones Spring Boot.
---
...
<Tabs groupId="language" queryString>
    <TabItem value="java" label="Java" default>
        ...
        ```yml reference title="resources/application.yaml (new code nester under the spring key)"
