...
description: GitHub provee dos herramientas gratuitas que manejan actualizaciones de dependencias y escaneo de seguridad automáticamente sin esfuerzo continuo una vez configuradas.
---
...
Después de configurar la observabilidad en la sección anterior, tu pipeline de deployment puede decirte cuando algo sale mal. Pero prevenir es mejor que detectar — y ahí es donde entran las actualizaciones de dependencias y el escaneo de seguridad. Tus dependencias se van a quedar desactualizadas. Tu código va a tener vulnerabilidades de seguridad que no conocías. No son hipótesis, son certezas. La única pregunta es si te enterás de forma proactiva o después de que algo se rompa.
...
```yaml reference title=".github/dependabot.yml"
https://raw.githubusercontent.com/franBec/springboot-demo-projects/a569c6649baa2ff681d1bcc8c7caaf9a8d3d5363/.github/dependabot.yml
```
...
Con Dependabot encargándose de las actualizaciones y CodeQL de la seguridad, tu repositorio ahora tiene guardrails automatizados que corren sin ningún esfuerzo manual. Tu pipeline de deployment está completo.
