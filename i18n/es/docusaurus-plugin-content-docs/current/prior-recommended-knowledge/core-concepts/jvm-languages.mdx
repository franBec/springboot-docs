...
[Kotlin](https://kotlinlang.org/) viene de JetBrains, la misma gente que te trajo [IntelliJ IDEA](/docs/prior-recommended-knowledge/development-environment/ide#por-qué-todos-usan-intellij-idea).
