...
- Por qué Docker es esencial para deployments modernos de Spring Boot.
- La estructura de un Dockerfile y cómo funcionan los multi-stage builds.
- Cuándo buildear contenedores localmente versus usar pipelines de CI/CD.
- Por qué el conocimiento de Docker importa incluso si no buildeás vos mismo las imágenes.
...
La mayoría de los proyectos establecidos ya tienen [pipelines CI/CD](/es/prior-recommended-knowledge/deployment-concepts/ci-cd) configurados:
...
Ahora entendés los conceptos básicos de Docker y cómo se aplican a las aplicaciones Spring Boot. Con esta base, estás listo para containerizar tus propios proyectos Spring Boot o colaborar efectivamente con equipos que usan Docker en sus pipelines de deployment.
