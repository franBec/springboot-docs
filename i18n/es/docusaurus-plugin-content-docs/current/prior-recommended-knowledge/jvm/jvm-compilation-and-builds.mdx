...
import {
  ...
  RuntimeFlowSequence,
} from '@site/src/components/docs/prior-recommended-knowledge/jvm/jvm-compilation-and-builds';
...
2. **Los JARs generados son gemelos**:
   ...
   - Mismos metadatos
3. **Los IDEs no les importa**: [IntelliJ IDEA](/prior-recommended-knowledge/development-environment/ide#por-qué-todos-usan-intellij-idea) auto-detecta ambos y muestra la barra de herramientas correspondiente de Maven o Gradle.
...
Entender el proceso de build te da la base para diagnosticar problemas cuando los builds fallan, optimizar tu flujo de trabajo de desarrollo, y razonar sobre lo que está pasando detrás de escena cuando presionás el botón de ejecutar.
