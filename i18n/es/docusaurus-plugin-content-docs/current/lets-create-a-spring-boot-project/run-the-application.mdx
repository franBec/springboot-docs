...
<Admonition type="info">
  Para este documento, asumo que creaste un proyecto Spring Boot usando [Spring
  Initializr](https://start.spring.io/). Si no lo hiciste, podés clonar el
  monorepo que preparé en
