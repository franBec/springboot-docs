...
3. Reemplazá `FilmRestMapper` con la Interface de MapStruct:

   <FilmRestMapper />

- **En tiempo de compilación**, MapStruct va a generar una implementación de tu interface `FilmRestMapper`.
