...
En teoría, las pruebas deberían ser lo primero que usás. En la práctica, es más atractivo comenzar con un escenario práctico y dejar que la necesidad de pruebas surja de problemas reales. ¿Por qué ocurre esto?
...
Entender dónde vive cada prueba en este espectro afecta tu ciclo de retroalimentación y el tiempo de ejecución del pipeline de CI.
