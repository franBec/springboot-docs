...
description: Define una especificación OpenAPI que describa el contrato de la API antes de escribir código de implementación, usando el patrón envelope para respuestas consistentes.
---
