...
- **Spring Container (`FilmService` & `FilmRepository`):** El [Contenedor de Spring](/es/spring-boot-in-a-nutshell/spring-ioc-container) es el corazón de tu app, manejando el ciclo de vida de tus beans.
...
Esta arquitectura en capas—Controller, Service, Repository—es la base de la mayoría de las aplicaciones Spring Boot. Cada capa tiene una única responsabilidad y delega el trabajo a la siguiente.
