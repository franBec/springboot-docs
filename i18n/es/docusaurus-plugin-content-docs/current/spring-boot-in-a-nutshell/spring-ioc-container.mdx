...
Le decís a Spring qué necesitás pidiendo la [interfaz](/prior-recommended-knowledge/interfaces-and-implementations). Hay varias formas de hacerlo, pero solo una es la correcta.
