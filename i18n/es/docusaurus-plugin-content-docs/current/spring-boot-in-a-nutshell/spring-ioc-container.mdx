...
La filosofía de Spring se construye sobre cuatro conceptos centrales:
...
Le decís a Spring qué necesitás pidiendo la [interfaz](/es/prior-recommended-knowledge/core-concepts/interfaces-and-implementations). Hay varias formas de hacerlo, pero solo una es la correcta.
...
Como nota final, **para cerrar el tema**, vale la pena ver el video de CodeAesthetic "Dependency Injection, The Best Pattern". El punto queda clarísimo.
