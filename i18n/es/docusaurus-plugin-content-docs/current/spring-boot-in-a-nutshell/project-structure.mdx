...
2. Obtiene la información de películas de una base de datos [Sakila](/prior-recommended-knowledge/sakila-sample-database) [H2](/persistence-integration/h2-database).
